...
const userId = 'Alice';
const currentAge = 30;
const homeCity = 'Paris';

console.log(`${userId} (${currentAge}) lives in ${homeCity}`);
...
const firstName = 'Guner';
const lastName = 'Keles'; 
...
let incrementedA = ++lastA;
const result =  incrementedA + lastB;
