...
function removeContact(name, contactBook) {
  console.log("Trying to remove contact:", name);
...
displayAllContacts(contacts);
addContact("Furkan", "5551112233", "furkan@gmail.com", contacts);
displayAllContacts(contacts);
viewContact("Furkan", contacts);
updateContact("Furkan", "5438769182", "furkan.new@gmail.com", contacts);
viewContact("Furkan", contacts);
removeContact("Furkan", contacts);
displayAllContacts(contacts);
