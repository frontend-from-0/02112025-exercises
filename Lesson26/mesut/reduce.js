...
const maxNumber = numbersEx2.reduce((max, number) => {
  return number > max ? number : max;
}, -Infinity);
console.log('Result ex2', maxNumber);
...
console.log('Result ex3', elementCounts); // Output: { a: 3, b: 2, c: 1 }
...
const average =
  numbersEx4.reduce((sum, number) => {
    return sum + number;
  }, 0) / numbersEx4.length;
  console.log('Result ex4', average);
...
const uniqueCount = numbers.reduce((accumulator, currentValue) => {
  ...
  console.log('Result ex5', uniqueCount);
