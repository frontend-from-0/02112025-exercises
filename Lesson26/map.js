...
const wordsExercise1Uppercase = wordsExercise1.map((word) => {
  return word.toUpperCase();
});

console.log('Ex.1', wordsExercise1, wordsExercise1Uppercase);
...
// const squareNumbers = numbersExercise2.map(function (number) {
...
const wordsLength = wordsExercise4.map(word => word.length);
console.log('Ex.4',wordsLength);
...
const studentInfo = studentsExercise5.map(
	info => info.name + " " + info.grade
)

// const studentsWithGrades = studentsExercise5.map(
// 	info => [info.name, info.grade] // Tuple
// )
console.log('Ex.5', studentInfo);
...
const stringNumbers = numbersExercise6.map((number) => {
...
const wordsArray = sentencesExercise7.map((sentence) => {
  return sentence.split(' ');
  });
  console.log('Ex.7', wordsArray);
...
const emailArray = usersExercise8.map((mail) => {
  return mail.email;
  });
  console.log('Ex.8', emailArray);
// Exercise 9:
...
const bookList = booksExercise9.map(
	book => 'Book Title: ' + book.title + " " + 'Book Name: ' + book.author
)
  console.log('Ex.9', bookList);
// Exercise 10:
...
const moneySymbolAdd = pricesExercise10.map((symbol) => {
  return symbol + ' TL';
  });
  console.log('Ex.10', moneySymbolAdd);