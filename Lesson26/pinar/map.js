...
const numbersToString = numbersExercise6.map((num)=>{
  return num.toString();
})

console.log("Exc. 6 result:", numbersToString);
...
console.log("Exc. 7 result:", splitSentences);
...
const usersEmails = usersExercise8.map((user)=>{
  return user.email;
})

console.log("Exc. 8 result:", usersEmails);
...
console.log("Exc. 9 result:", titlesAndAuthors);
...
console.log("Exc. 10 result:", pricesWithCurrency);