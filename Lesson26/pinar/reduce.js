...
console.log("Exc. 2 result:", maxValue);
...
console.log("Exc. 3 result:", elementCounts); // Output: { a: 3, b: 2, c: 1 }
...
const avarageOfNumbers = total / numbersEx4.length;

console.log("Exc. 4 result:", avarageOfNumbers);
...
console.log("Exc. 5 result:" , uniqueCount); // Output: 5
